...
class MDM(nn.Module):
    ...
    def clip_encode_text(self, raw_text):
        ...
        max_text_len = 20 if self.dataset in ['humanml', 'kit', 'shelf_assembly'] else None  # Specific hardcoding for humanml dataset
...
class InputProcess(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.data_rep in ['rot6d', 'xyz', 'hml_vec', 'rotquat']:
