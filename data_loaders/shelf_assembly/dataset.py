...
class ShelfAssemblyDataset(data.Dataset):
    def __init__(
        ...
        # For collab_prediction task, reorganize data to pair Main and Sub motions
        if self.task == 'collab_prediction':
    ...
    def __getitem__(self, idx):
        ...
        # For collab_prediction, process both main and sub motions
        if self.task == 'collab_prediction' and 'main_motion' in motion:
